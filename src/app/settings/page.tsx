...
export default function SettingsPage() {
    ...
    const [settings, setSettings] = useState({
        ...
        GALLABOX_TRIAL_REMINDER_TEMPLATE: 'gentle_trial_reminder_tomorrow',
        AUTOMATION_EXOTEL_ENABLED: 'true',
        AUTOMATION_CODA_ENABLED: 'true',
        AUTOMATION_TRIAL_CLASS_ENABLED: 'true',
        AUTOMATION_TRIAL_REMINDER_ENABLED: 'true'
    });
                ...
                <form onSubmit={handleSave} className="space-y-8 bg-white shadow-sm border border-gray-200 rounded-xl p-6 sm:p-10">
                    ...
                    <div className="pt-4">
                        ...
                        <div className="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-6">
                            ...
                            <div className="sm:col-span-1">
                                <label className="block text-sm font-medium text-gray-700">Trial Reminder Temp.</label>
                                <input type="text" name="GALLABOX_TRIAL_REMINDER_TEMPLATE" value={settings.GALLABOX_TRIAL_REMINDER_TEMPLATE} onChange={handleChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm px-3 py-2 border bg-gray-50" />
                            </div>
                        </div>
                    </div>
